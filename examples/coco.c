...
void validate_coco(char *cfg, char *weights)
{
    ...
    char *base = "results/";
    dnlist *plist = get_paths("data/coco_val_5k.list");
    //dnlist *plist = get_paths("/home/pjreddie/data/people-art/test.txt");
    //dnlist *plist = get_paths("/home/pjreddie/data/voc/test/2007_test.txt");
    char **paths = (char **)list_to_array(plist);
